...
gulp.task("fast_images", () => {
    return gulp.src(paths.fast_images.src)
        .pipe(newer(paths.fast_images.dist))
        .pipe(gulpif(production, imagemin([
            imageminGiflossy({
                optimizationLevel: 3,
                optimize: 3,
        ...
        .pipe(gulp.dest(paths.fast_images.dist))
        .pipe(debug({
            "title": "Images"
        }))
        .pipe(browsersync.stream());
...
gulp.task("flowers_light_images", () => {
    return gulp.src(paths.flowers_light_images.src)
        .pipe(newer(paths.flowers_light_images.dist))
        .pipe(gulpif(production, imagemin([
            imageminGiflossy({
                optimizationLevel: 3,
                optimize: 3,
        ...
        .pipe(gulp.dest(paths.flowers_light_images.dist))
        .pipe(debug({
            "title": "Images"
        }))
        .pipe(browsersync.stream());
